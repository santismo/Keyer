...
assert.match(html, /id="openMidiFile"/);
assert.match(html, /id="midiFileInput"[^>]*accept="\.mid,\.midi,audio\/midi,audio\/x-midi"/);
assert.match(html, /id="midiTrack"/);
assert.match(html, /id="midiRoll"/);
assert.match(html, /id="showChart"/);
assert.match(html, /id="showMidiView"/);
...
assert.match(css, /\.midi-roll-zoom/);
assert.match(css, /\.piano-key\.white\.raw-midi-tone/);
assert.match(css, /\.fretboard-cell\.raw-midi-tone/);
...
assert.match(js, /function originalMidiModeActive\(/);
assert.match(js, /function originalMidiNotes\(/);
assert.match(js, /function rawMidiFretboardPositions\(/);
assert.match(js, /function setMidiRollZoom\(/);
assert.match(js, /state\.showMidiView && !state\.midi && state\.midiEntry/);
...
assert.doesNotMatch(js, /elements\.loadMidi/);
assert.match(js, /elements\.midiFileInput\?\.addEventListener\('change'/);
assert.match(js, /function loadLocalMidiFile\(/);
assert.match(js, /function buildInferredMidiChart\(/);
assert.match(js, /function renderImportedMidiRoll\(/);
assert.match(js, /function seekTimelineBeat\(/);
assert.match(js, /state\.playheadBeat/);
...
assert.match(desktopHtml, /id="openMidiFile"/);
assert.match(desktopHtml, /id="midiFileInput"/);
assert.match(desktopHtml, /id="midiTrack"/);
assert.match(desktopHtml, /id="midiRoll"/);
